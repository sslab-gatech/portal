...
functions require to initialize the data structure associated with the iommu
instance. In this case, SMMU related functions that manages CD and STE are 
assigned and invoked to handle the new mmu region. 
