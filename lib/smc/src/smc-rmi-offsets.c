...
COMPILER_ASSERT(offsetof(struct rmi_rec_exit, portal_dev_base) == 0x518);
COMPILER_ASSERT(offsetof(struct rmi_rec_exit, portal_dev_size) == 0x520);
COMPILER_ASSERT(offsetof(struct rmi_rec_exit, portal_dev_target_rd) == 0x528);
COMPILER_ASSERT(offsetof(struct rmi_rec_exit, portal_dev_flag) == 0x530);
