...
REG32(SMMU_ROOT_IDR0,          (SMMU_ROOT_PAGE_OFFSET + 0x0000))
    ...
    FIELD(SMMU_ROOT_IDR0, RGPTM, 0, 1) 

REG32(SMMU_ROOT_IIDR,          (SMMU_ROOT_PAGE_OFFSET + 0x0008))
    FIELD(SMMU_ROOT_IIDR, Implementer, 0, 12) 
    FIELD(SMMU_ROOT_IIDR, Revision, 12, 4) 
    FIELD(SMMU_ROOT_IIDR, Variant, 16, 4) 
    FIELD(SMMU_ROOT_IIDR, ProductID, 20, 12) 

REG32(SMMU_ROOT_CR0,           (SMMU_ROOT_PAGE_OFFSET + 0x0020))
    FIELD(SMMU_ROOT_CR0, ACCESSEN, 0, 1) 
    FIELD(SMMU_ROOT_CR0, GPCEN, 1, 1) 

REG32(SMMU_ROOT_CR0ACK,        (SMMU_ROOT_PAGE_OFFSET + 0x0024))
    FIELD(SMMU_ROOT_CR0ACK, ACCESSEN, 0, 1) 
    FIELD(SMMU_ROOT_CR0ACK, GPCEN, 1, 1) 

REG64(SMMU_ROOT_GPT_BASE,      (SMMU_ROOT_PAGE_OFFSET + 0x0028))
    FIELD(SMMU_ROOT_GPT_BASE, ACCESSEN, 12, 40) 

REG64(SMMU_ROOT_GPT_BASE_CFG,  (SMMU_ROOT_PAGE_OFFSET + 0x0030))
    FIELD(SMU_ROOT_GPT_BASE_CFG, PPS, 0, 3) 
    FIELD(SMU_ROOT_GPT_BASE_CFG, IRGN, 8, 2) 
    FIELD(SMU_ROOT_GPT_BASE_CFG, ORGN, 10, 2) 
    FIELD(SMU_ROOT_GPT_BASE_CFG, SH, 12, 2) 
    FIELD(SMU_ROOT_GPT_BASE_CFG, PGS, 14, 2) 
    FIELD(SMU_ROOT_GPT_BASE_CFG, GPCP, 17, 1) 
    FIELD(SMU_ROOT_GPT_BASE_CFG, L0GPTSZ, 20, 4) 

REG64(SMMU_ROOT_GPF_FAR,       (SMMU_ROOT_PAGE_OFFSET + 0x0038))
    FIELD(SMMU_ROOT_GPF_FAR, FAULT, 0, 1) 
    FIELD(SMMU_ROOT_GPF_FAR, REASON, 1, 3) 
    FIELD(SMMU_ROOT_GPF_FAR, FAULTCODE, 4, 8) 
    FIELD(SMMU_ROOT_GPF_FAR, FADDR, 12, 40) 
    FIELD(SMMU_ROOT_GPF_FAR, FPAS, 62, 2) 

REG64(SMMU_ROOT_GPT_CFG_FAR,   (SMMU_ROOT_PAGE_OFFSET + 0x0040))
    FIELD(SMMU_ROOT_GPT_CFG_FAR, FAULT, 0, 1) 
    FIELD(SMMU_ROOT_GPT_CFG_FAR, REASON, 1, 3) 
    FIELD(SMMU_ROOT_GPT_CFG_FAR, FAULTCODE, 4, 8) 
    FIELD(SMMU_ROOT_GPT_CFG_FAR, FADDR, 12, 40) 
    FIELD(SMMU_ROOT_GPT_CFG_FAR, CFG_ERR, 56, 4) 
    FIELD(SMMU_ROOT_GPT_CFG_FAR, FPAS, 62, 2) 

REG64(SMMU_ROOT_TLBI,          (SMMU_ROOT_PAGE_OFFSET + 0x0050))
    FIELD(SMU_ROOT_TLBI, Address, 12, 40)
    FIELD(SMU_ROOT_TLBI, SIZE, 4, 4)
    FIELD(SMU_ROOT_TLBI, L, 1, 1)
    FIELD(SMU_ROOT_TLBI, ALL, 0, 1)

REG32(SMMU_ROOT_TLBI_CTRL,     (SMMU_ROOT_PAGE_OFFSET + 0x0058))
    FIELD(SMU_ROOT_TLBI, RUN, 0, 1)
