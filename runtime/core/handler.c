...
static const struct smc_handler smc_handlers[] = {
	...
	HANDLER_1(SMC_RMM_GRANULE_DELEGATE,	 smc_granule_delegate,		true, true),
	HANDLER_1(SMC_RMM_GRANULE_UNDELEGATE,	 smc_granule_undelegate,	true, true),
	...
	HANDLER_5(SMC_RMM_DATA_CREATE,		 smc_data_create,		true, true),
	HANDLER_3(SMC_RMM_DATA_CREATE_UNKNOWN,	 smc_data_create_unknown,	true, true),
	HANDLER_2(SMC_RMM_DATA_DESTROY,		 smc_data_destroy,		true , true),
	HANDLER_4(SMC_RMM_RTT_CREATE,		 smc_rtt_create,		true, true),
	HANDLER_4(SMC_RMM_RTT_DESTROY,		 smc_rtt_destroy,		true, true),
	HANDLER_4(SMC_RMM_RTT_FOLD,		 smc_rtt_fold,			true, true),
	HANDLER_4(SMC_RMM_RTT_MAP_UNPROTECTED,	 smc_rtt_map_unprotected,	true, true),
	HANDLER_3(SMC_RMM_RTT_UNMAP_UNPROTECTED, smc_rtt_unmap_unprotected,	true, true),
	HANDLER_3_O(SMC_RMM_RTT_READ_ENTRY,	 smc_rtt_read_entry,		true, true, 4U),
	...
	HANDLER_3(SMC_RMM_RTT_INIT_RIPAS,	 smc_rtt_init_ripas,		true, true),
	HANDLER_5(SMC_RMM_RTT_SET_RIPAS,	 smc_rtt_set_ripas,		true, true)
};
