...
static const struct smc_handler smc_handlers[] = {
	HANDLER_0(SMC_RMM_VERSION,		 smc_version,			false,  false),
	HANDLER_1_O(SMC_RMM_FEATURES,		 smc_read_feature_register,	false,  false, 1U),
	HANDLER_1(SMC_RMM_GRANULE_DELEGATE,	 smc_granule_delegate,		false,  false),
	HANDLER_1(SMC_RMM_GRANULE_UNDELEGATE,	 smc_granule_undelegate,	false,  false),
	HANDLER_2(SMC_RMM_REALM_CREATE,		 smc_realm_create,		false,  false),
	HANDLER_1(SMC_RMM_REALM_DESTROY,	 smc_realm_destroy,		false,  false),
	HANDLER_1(SMC_RMM_REALM_ACTIVATE,	 smc_realm_activate,		false,  false),
	HANDLER_3(SMC_RMM_REC_CREATE,		 smc_rec_create,		false,  false),
	HANDLER_1(SMC_RMM_REC_DESTROY,		 smc_rec_destroy,		false,  false),
	HANDLER_2(SMC_RMM_REC_ENTER,		 smc_rec_enter,			false, false),
	...
	HANDLER_2(SMC_RMM_DATA_DESTROY,		 smc_data_destroy,		false, false),
	HANDLER_4(SMC_RMM_RTT_CREATE,		 smc_rtt_create,		false, false),
	HANDLER_4(SMC_RMM_RTT_DESTROY,		 smc_rtt_destroy,		false, false),
	HANDLER_4(SMC_RMM_RTT_FOLD,		 smc_rtt_fold,			false, false),
	HANDLER_4(SMC_RMM_RTT_MAP_UNPROTECTED,	 smc_rtt_map_unprotected,	true, true),
	HANDLER_3(SMC_RMM_RTT_UNMAP_UNPROTECTED, smc_rtt_unmap_unprotected,	false, false),
	HANDLER_3_O(SMC_RMM_RTT_READ_ENTRY,	 smc_rtt_read_entry,		false, false, 4U),
